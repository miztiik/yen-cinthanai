...
Screens, components, glyphs, tokens. Mid-tier Android portrait (~390x844). Tailwind for chrome only; canvas/board internals excluded. Three glyph packs ship v1 (household, creatures, abstract). Visual clarity (colour-is-one-signal), not a11y tooling.
